...
export async function POST(request: NextRequest) {
  try {
    ...
    const html = `Hi Doctor,<br/><br/>Please find attached your report for ${patientName} from recent consultation.<br/><br/><strong>NOTE</strong> - This email has been generated from the sandbox environment, and has therefore been routed to this email address instead of the listed recipient.`;
