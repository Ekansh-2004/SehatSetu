...
import { Activity, ArrowRight, BarChart3, Calendar, CheckCircle2, ChevronRight, Database, FileText, HeartPulse, Lock, Mail, MapPin, Mic, Shield, Sparkles, Star, Stethoscope, Users, Video, Zap } from "lucide-react";
...
const features = [
	{
		icon: Mic,
		title: "AI Scribe",
		description: "Speech recognition technology converts spoken consultations into written notes, allowing doctors to focus on patient care.",
		bgColor: "bg-blue-600",
	...
	},
	{
		...
		description: "Streamlined scheduling system with automated SMS reminders to help reduce missed appointments and optimize clinic capacity.",
		bgColor: "bg-teal-600",
	...
	},
	{
		...
		description: "Comprehensive dashboard providing insights into patient flow, appointments, and clinic operations for informed decision-making.",
	...
	},
	{
		...
		description: "Integrated telemedicine capabilities enabling remote patient consultations with secure, high-quality video communication.",
	...
	},
	{
		...
		description: "HIPAA-compliant digital record management with encrypted storage and organized patient information access.",
		bgColor: "bg-rose-600",
	...
	},
	{
		...
		description: "Easy-to-use patient interface for appointment booking, SMS communication, and accessing medical information.",
...
export default function LandingPage() {
	...
	return (
        ...
        `}
			...
			<div
				ref={containerRef}
				className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-hidden relative"
			>
							...
							<div className="flex items-center space-x-4">
								<Link href="/privacy-policy">
									<Button
										variant="ghost"
										size="sm"
										className="hidden sm:inline-flex text-slate-700 hover:text-blue-600 hover:bg-blue-50"
									>
										Privacy Policy
									</Button>
								</Link>
								<Link href="/book">
									<Button
										variant="outline"
										size="sm"
										className="hidden md:inline-flex border-2 border-blue-500 text-blue-600 hover:bg-blue-50"
									>
										Book Appointment
									</Button>
								</Link>
						...
						>
							...
							>
								<div className="inline-flex items-center space-x-3 px-8 py-4 rounded-full border-2 border-blue-300/50 bg-gradient-to-r from-white/80 to-blue-50/80 backdrop-blur-xl">
									...
									<span className="text-sm font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">Rural Healthcare Management Platform</span>
							...
							>
								<h1 className="text-6xl sm:text-7xl lg:text-8xl xl:text-9xl font-black tracking-tight leading-none">
									...
									>
										<span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">Rural Care</span>
									</motion.span>
								</h1>
								<motion.p
									initial={{ opacity: 0 }}
								...
								>
									Bridge the rural-urban healthcare gap with appointment booking, voice notes in local languages, and mobile-first patient access
								</motion.p>
							</motion.div>
						...
						>
							...
							>
								<div className="inline-flex items-center space-x-2 px-6 py-3 rounded-full border-2 border-purple-300/50 bg-gradient-to-r from-purple-50 to-pink-50 backdrop-blur-xl">
									...
									<span className="text-sm font-bold text-purple-700">Comprehensive Features</span>
								</div>
							</motion.div>
							<h2 className="text-5xl sm:text-6xl lg:text-7xl font-black mb-8 text-slate-800">
								Everything You Need
								<span className="block bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent mt-2">In One Platform</span>
							</h2>
							<p className="text-xl text-slate-600 max-w-3xl mx-auto">Streamlined tools designed for modern healthcare practices</p>
						</motion.div>
				...
				{/* Schemes Section - Rural Button Group */}
				<section className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
					<div className="max-w-7xl mx-auto">
						<motion.div
							initial={{ opacity: 0, y: 40 }}
							whileInView={{ opacity: 1, y: 0 }}
						...
						>
							<motion.div
								...
								className="inline-block mb-8"
							>
								<div className="inline-flex items-center space-x-2 px-6 py-3 rounded-full border-2 border-indigo-300/50 bg-gradient-to-r from-indigo-100 to-purple-100 backdrop-blur-xl">
									<Sparkles className="h-5 w-5 text-indigo-600" />
									<span className="text-sm font-bold text-indigo-700">Government Schemes</span>
								</div>
							</motion.div>
							<motion.div>
								<h2 className="text-5xl sm:text-6xl lg:text-7xl font-black mb-8 text-slate-800">
									Access <span className="block bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mt-2">Healthcare Schemes</span>
								</h2>
								<p className="text-xl text-slate-600 max-w-3xl mx-auto">Discover government schemes tailored for patients, doctors, and staff. Select your category to explore eligible programs.</p>
							</motion.div>
						</motion.div>

						{/* Button Group - Similar to feature cards but button-focused */}
						<div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
							{[
								{ icon: Users, title: "Patient Schemes", desc: "Health insurance, treatment subsidies, and welfare programs for patients.", color: "from-blue-500 to-cyan-600", textColor: "text-slate-800", hoverColor: "hover:border-blue-300 hover:shadow-blue-200/50", role: "patient" },
								{ icon: Stethoscope, title: "Doctor Schemes", desc: "Professional development, insurance, and practice support for healthcare providers.", color: "from-emerald-500 to-teal-600", textColor: "text-slate-800", hoverColor: "hover:border-emerald-300 hover:shadow-emerald-200/50", role: "doctor" },
								{ icon: Shield, title: "Staff Schemes", desc: "Training, welfare benefits, and support programs for medical staff.", color: "from-purple-500 to-pink-600", textColor: "text-slate-900", hoverColor: "hover:border-purple-300 hover:shadow-purple-200/50", role: "staff" },
							].map((scheme, index) => (
								<motion.div
									key={index}
									initial={{ opacity: 0, y: 50 }}
								...
								>
									<Link
										href={`/scheme?role=${scheme.role}`}
										className="block h-full"
									>
										<div className={`relative h-full bg-white rounded-2xl p-8 border border-slate-200 group-hover:border-slate-300 transition-all duration-300 shadow-md group-hover:shadow-xl ${scheme.hoverColor}`}>
											{/* Icon */}
											<div className="mb-6">
												<div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${scheme.color} flex items-center justify-center shadow-lg`}>
													<scheme.icon className="h-8 w-8 text-white" />
												</div>
											</div>
											{/* Title & Desc */}
											<h3 className={`text-2xl font-bold mb-4 ${scheme.textColor}`}>{scheme.title}</h3>
											<p className="text-slate-600 leading-relaxed">{scheme.desc}</p>
											{/* Arrow */}
											<div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
												<ArrowRight className="h-6 w-6 text-indigo-600 group-hover:translate-x-1 transition-transform" />
											</div>
										</div>
									</Link>
								</motion.div>
								...
								<div className="grid lg:grid-cols-2 gap-12 items-center">
									<div className="space-y-8">
										...
										>
											...
											<span className="text-sm font-bold text-emerald-700">Enterprise Security</span>
										</motion.div>
										...
										>
											Security &<span className="block bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Compliance</span>
										</motion.h2>
										...
										>
											Built with security at its core. All data is encrypted and stored in HIPAA-compliant infrastructure with Business Associate Agreements in place.
										</motion.p>
				...
				<section
					id="contact"
					className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 to-blue-900"
				>
					<div className="max-w-7xl mx-auto">
						<motion.div
							initial={{ opacity: 0, y: 40 }}
						...
						>
							<h2 className="text-4xl lg:text-5xl font-black text-white mb-6">Get in Touch</h2>
							<p className="text-xl text-blue-200 max-w-3xl mx-auto">Ready to streamline your practice? Contact us to learn more.</p>
						</motion.div>
						...
						<div className="grid md:grid-cols-3 gap-8">
							...
							>
								<div className="bg-white/10 backdrop-blur-xl border-2 border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300 h-full">
									...
									<p className="text-blue-200 mb-4">Get in touch with our team</p>
									<p className="text-blue-300 font-mono text-sm">sales@livconnect.ai</p>
								</div>
							</motion.a>
							...
							>
								<div className="bg-white/10 backdrop-blur-xl border-2 border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300 h-full">
									...
									<p className="text-blue-200 mb-4">See our platform in action</p>
									<p className="text-blue-300 text-sm">Click the floating button to book</p>
								</div>
							</motion.div>
							...
							>
								<div className="bg-white/10 backdrop-blur-xl border-2 border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300 h-full">
									...
									<p className="text-blue-200 mb-4">Connect with our team</p>
									<p className="text-blue-300 text-sm">India</p>
								</div>
							</motion.div>
						</div>
					</div>
						...
						>
							...
							<div className="relative p-12 lg:p-24 text-center">
								...
								<h2 className="text-5xl lg:text-7xl font-black text-slate-800 mb-6">
									Ready to Transform
									<span className="block bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent mt-2">Your Practice?</span>
								</h2>
								<p className="text-2xl text-slate-700 max-w-3xl mx-auto mb-12 leading-relaxed">Join healthcare providers who have streamlined their operations with Clinix</p>
					...
					<div className="max-w-7xl mx-auto">
						<div className="grid md:grid-cols-5 gap-12 mb-16">
							...
							<div className="md:col-span-2 space-y-6">
								<Logo size="md" />
								<p className="text-slate-600 leading-relaxed max-w-md">Rural healthcare management platform for streamlined medical practices.</p>
								<div className="flex items-center space-x-4">
						...
						<div className="border-t-2 border-slate-300/50 pt-12 mb-12">
							<div className="grid md:grid-cols-2 gap-8">
								<div className="flex items-start space-x-4">
									...
									<div>
										<div className="font-bold text-slate-900 mb-1">Contact Sales</div>
										<a
											href="mailto:sales@livconnect.ai"
						...
						<div className="border-t-2 border-slate-300/50 pt-8">
							<div className="flex flex-col md:flex-row justify-between items-center gap-6">
								<p className="text-slate-600 text-sm">
									© 2025 <span className="font-bold">CLINIX</span> <span className="text-slate-500">by livconnect</span>. All rights reserved.
								</p>
